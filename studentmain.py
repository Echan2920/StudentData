...
def create_data(Username,Password,Name,Age,Date_of_Birth,Address,Contact_No,Guardians_Name,Guardians_Contact_No,Elementary,High_School,Senior_High_School,College,Semester,Subjects_Name,Subjects_Description,Credits_Units):
    ...
    cursor.execute(f"""INSERT INTO data VALUES("{Username}","{Password}","{Name}","{Age}","{Date_of_Birth}","{Address}","{Contact_No}","{Guardians_Contact_No}","{Guardians_Contact_No}","{Elementary}","{High_School}","{Senior_High_School}","{College}","{Semester}","{Subjects_Name}","{Subjects_Description}","{Credits_Units})""")
    connection.commit()
    connection.close()
...
def Student_Data():
    ...
    #Calling Login and Destroying its Frame
    def forward_to_Login():
        Student_Data1_fm.destroy()
        Login()

    #Calling Admin and Destroying its Frame
    def forward_to_Admin():
        Student_Data1_fm.destroy()
        Admin()

    #Calling Sign up and Destroying its Frame
...
def Admin():
    ...
    #Calling enter button to go to Admin1
...
def Login1():
    ...
    #Calling Student Data and Deleting the frame of Login1
    def forward_to_Student_Data():
...
def Admin1():
    ...
    #Calling Student Data and Deleting the frame of Admin1
    def forward_to_Student_Data():
